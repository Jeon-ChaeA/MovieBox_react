...
const MyPage = () => {
  ...
  return (
    <Container className="my-5" style={{ color: "#ffffff", backgroundColor: "#1f2937", padding: "20px", borderRadius: "10px" }}>
      <h1 className="text-center text-white">내 정보</h1>
        ...
        <Card.Body className="d-flex align-items-center">
          ...
          <div>
            <p style={{ marginBottom: "0.5rem" }}>
              <strong style={{ display: "inline" }}>이름:</strong>{" "}
              <span style={{ display: "inline" }}>{userInfo.name}</span>
            </p>
            <p style={{ marginBottom: "0.5rem" }}>
              <strong style={{ display: "inline" }}>이메일:</strong>{" "}
              <span style={{ display: "inline" }}>{userInfo.email}</span>
            </p>
